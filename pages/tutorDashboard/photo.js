...
function ProfilePhoto() {
  ...
  return (
    ...
    <div className='  font-bold '>
      ...
      <div
        id="heading"
        className="col-span-12  py-5 text-3xl px-5  xl:px-20 font-semibold text-[#3d3d3d]"
        >
        Profile Photo
      </div>
      <hr className='text-[#E2E2E2]'/>
      <div className="text-[#545454] my-10  px-5  xl:px-20">
      ...
      <div className="grid grid-cols-12 px-5 text-[#545454]  xl:px-20 ">
          ...
          <div className=" mb-20 flex">
            <Dropzone
              ...
              {({ getRootProps, getInputProps }) => (
                <div {...getRootProps({ className: 'dropzone md:w-96 w-full ' })}>
                  <input {...getInputProps()} />
        ...
        <div className="col-span-12 md:col-span-6 space-y-8 md:mt-0 mt-6">
          ...
          <div>
            <div className=" grid grid-cols-12 gap-y-4  text-[#838383]">
              ...
              <div className=" col-span-11 ">
                ...
                <FiCheckCircle className="b-colo " />
              <div className=" col-span-11 ">
                your face and eyes are fully visible &#40;except for redivgious
                reasons &#41;
              </div>
                <FiCheckCircle className="b-colo " />
              <div className=" col-span-11  ">
